...
def process_commit(commit: str, coverage: bool = True):
    ...
    if not configure_libxml2(PROJECT_DIR, coverage=coverage): return None
    if not build_libxml2(PROJECT_DIR): return None
    
    suite = get_libxml2_tests(PROJECT_DIR)
